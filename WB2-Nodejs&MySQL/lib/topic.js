        ...
        db.query(`SELECT * FROM topic WHERE id =?`, [queryData.id], function (error2, topic) {
          ...
          db.query(`SELECT * FROM author`,function(error2,authors){
            ...
            var html = template.html(sanitizeHTML(topic[0].title), list,
              ...
              <p>제목 : <input type = "text" name = "title" placeholder = "title" value = "${sanitizeHTML(topic[0].title)}"></p>
              <p><textarea name = "description" cols = "60" rows = "20" placeholder = "description">${sanitizeHTML(topic[0].description)}</textarea></p>
              <p>
